  ...
  return (
    <section className="flex shrink-0 snap-start h-[calc(100svh-4rem)] w-full flex-col items-center justify-center gap-2 text-center lg:flex-row lg:justify-between lg:px-20 lg:py-10">
      ...
      <div className="relative p-1 h-52 w-52 shrink-0 rounded-full border-[6px] border-primary lg:order-2 lg:h-96 lg:w-96">
        ...
        />
        {/* Add tint */}
        <div className="absolute inset-0 rounded-full bg-primary/20 m-1"> </div>
      </div>

      <div className="flex w-[70%] lg:w-[40%] flex-col gap-6 lg:order-1 lg:text-left">
        ...
        <menu className="flex flex-col gap-4 lg:flex-row">
          <button className="w-full rounded-md bg-primary px-6 py-2 text-lg font-bold text-white lg:w-fit">
            <a href='/pdf.pdf' download={true}>Download CV</a>
          </button>
